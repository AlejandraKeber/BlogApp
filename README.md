...
**[BlogApp]** is a blog website created with Ruby on Rails. It will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
  git clone https://github.com/AlejandraKeber/BlogApp.git
  cd BlogApp
```
...
Feel free to check the [issues page](https://github.com/AlejandraKeber/BlogApp/issues).
